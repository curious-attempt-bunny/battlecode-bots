...
public abstract class BaseRobot {
    ...
    protected MapLocation rallyPoint() throws GameActionException {
        if (rc.readBroadcast(102) == 1) {
            rallyPoint = new MapLocation(rc.readBroadcast(100), rc.readBroadcast(101));
        }
        return rallyPoint;
    }

    protected int tick() throws GameActionException {
        return this instanceof HQ ? tick : rc.readBroadcast(99);
    }
